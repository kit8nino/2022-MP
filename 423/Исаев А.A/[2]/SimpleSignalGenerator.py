...
class SimpleSignalGenerator:
    ...
    def create_garmonic_signal(self): #Построение гармонического колебания
    ...
    def create_triangular_signal(self): #  Построение треугольного сигнала 
    ...
    def create_pulse_width_modulation(self): #Построение ШИМ сигнала  
    ...
    def create_signal_saw(self): # Построение сигнала пилы 
