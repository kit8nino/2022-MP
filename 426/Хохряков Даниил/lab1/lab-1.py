...
def coords_of_treasure():
    ...
    while q == 0:
        ...
        if maze[coord_treasure[1]][coord_treasure[0]] == '#':
            print('Error! Choose another place for the threasure.')
        else:
...
start_point = get_symbol(maze, 0)
exit_point = get_symbol(maze, max_y - 1)

treasure_is_here = []
treasure_is_here = coords_of_treasure()

change_symbol(maze_list, treasure_is_here, '*')
