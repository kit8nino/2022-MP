...
class Analyzer():
    ...
    def create_fourier_spectrum(self): #Создает спект Фурье сигнала 
    ...
    def сounting_characteristics(self): # Подсчет дисперсии, среднего, медианного, минимально и максимального значения, размах сигнала 
    ...
    def inverse_fourier_transform(self): #Обратное преобразование Фурье 
