...
from generator_simle import generator_simple

class generator_complex(generator_simle):

    def __init__(self, frequency, frequency_discret, time_in_sec, amplitude):
        generator_simle.__init__(self, frequency, frequency_discret, time_in_sec, amplitude)
