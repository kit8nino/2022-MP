...
class Generator(simple_generator.Simple_generator):
    ...
    def __init__(self, listSignals : List[Dict[float , float]] , frequence_signal_sec : float,                  period_sec: float, sampling_frequency_sec: float,
        ...
        for t in m_allSignals:
            self.m_signal[t] = (super().getSignalForTime(t)[t] *                                (1 + m_allSignals[t] / maxValue)).real
