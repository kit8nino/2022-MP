...
def enter_coord_of_treasure():
    q = 0
    while q == 0:
        coord_treasure[0] = int(input(f'Where is the treasure? (x is between 1 and {max_x}) ')) - 1 
        coord_treasure[1] = int(input(f'Where is the treasure? (y is between 1 and {max_y}) ')) - 1
